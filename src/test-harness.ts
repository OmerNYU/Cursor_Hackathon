...
import type { FramePack, Features, Scores, TipRule } from './lib/types.js';
 ...
 */
function processFrames(frames: FramePack[]): {
  features: Features[];
  scores: Scores[];
  tips: TipRule[][];
} {
 ...
 */
function testStillSubject(): TestResult {
 ...
 */
function testLookAway(): TestResult {
 ...
 */
function testWalkAround(): TestResult {
