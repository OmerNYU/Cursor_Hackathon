...
export const WEIGHTS = { P: 0.4, E: 0.3, S: 0.2, C: 0.1 };
 ...
 */
export const DEFAULT_TIP_RULES = [
    {
        id: 'eye-contact-poor',
        priority: 1, // highest priority
        windowSec: 2,
        cooldownSec: 6,
        when: (f, _s) => f.gazeDevDeg > GAZE_BREAK_DEG,
    ...
    },
    {
        ...
        windowSec: 2,
        cooldownSec: 6,
        when: (f, _s) => f.wristVelStd > WRIST_VEL_STD_HIGH,
    ...
    },
    {
        ...
        windowSec: 2,
        cooldownSec: 6,
        when: (f, _s) => f.torsoSpeed > TORSO_SPEED_HIGH,
    ...
    },
    {
        ...
        windowSec: 3,
        cooldownSec: 8,
        when: (f, _s) => f.gazeBreaksPerMin > GAZE_MAX_BREAKS_PER_MIN,
